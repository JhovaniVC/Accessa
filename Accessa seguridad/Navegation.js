...
import BitacoraAccesosListScreen from './src/screen/Residente copy/Bitacora/BitacoraAccesosListScreen';
...
function MyStackBitacoras() {
    return (
        <Stack.Navigator>
            ...
            <Stack.Screen name="AccesosList" component={BitacoraAccesosListScreen} options={{ title: 'Registros de Accesos' }} />
