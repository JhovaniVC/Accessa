...
export default function ScreenHomeSecurity({ navigation }) {
    ...
    const goToBit =()=> navigation.navigate('Bitacora')
    return (
            ...
            <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.actionsGrid}>
                    <ActionCard
                        icon="book"
                        title="Bitacora"
                        subtitle="Registro de accesos y entregas"
                        onPress={goToBit}
                    />
                    <ActionCard
                        icon="file-document"
                        title="Reportes"
                        subtitle="Monitorear reportes exitentes"
                        onPress={goToReportes}
                    />
                    <ActionCard
                        icon="qrcode"
                        title="Escaner QR"
                        subtitle="Leer soliciitudes recibidas"
                        onPress={goToQR}
